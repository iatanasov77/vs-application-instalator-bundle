 ...
 */
final class Version20220228081322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSCMS_TocPage ADD title VARCHAR(255) NOT NULL, ADD description VARCHAR(255) DEFAULT NULL, DROP taxon_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSCMS_TocPage ADD taxon_id INT DEFAULT NULL, DROP title, DROP description, CHANGE text text LONGTEXT DEFAULT NULL COLLATE `utf8_unicode_ci`');
        $this->addSql('ALTER TABLE VSCMS_TocPage ADD CONSTRAINT FK_6B1FF241DE13F470 FOREIGN KEY (taxon_id) REFERENCES VSAPP_Taxons (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
