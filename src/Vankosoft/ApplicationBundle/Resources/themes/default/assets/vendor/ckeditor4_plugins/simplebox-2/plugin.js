...
CKEDITOR.plugins.add( 'simplebox-2', {
	...
	init: function( editor ) {
		...
		CKEDITOR.dialog.add( 'simplebox-2', this.path + 'dialogs/simplebox.js' );

		// Register the simplebox widget.
		editor.widgets.add( 'simplebox-2', {
